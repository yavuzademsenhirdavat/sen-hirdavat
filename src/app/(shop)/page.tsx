      ...
      <section className="bg-slate-800 relative overflow-hidden">
        ...
        <div className="relative max-w-[1280px] mx-auto px-4 py-16 md:py-24 grid md:grid-cols-[1.1fr_1fr] gap-10 md:gap-16 items-center">
          ...
          <div>
            ...
            <h1 className="font-display font-extrabold tracking-tight text-white leading-[0.93] text-balance"
                style={{ fontSize: 'clamp(42px, 6vw, 84px)' }}>
              {TONE.title}
            </h1>
            <p className="mt-7 text-slate-400 leading-relaxed max-w-lg"
               style={{ fontSize: 'clamp(15px, 1.5vw, 19px)' }}>
              {TONE.sub}
            </p>

            {/* Trust badges */}
            <div className="mt-8 flex flex-wrap gap-x-5 gap-y-2 text-[13px] text-slate-400">
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 h-14 px-6 text-slate-200 font-medium text-[15px] rounded-xl transition hover:bg-white/10"
            ...
            <div className="mt-14 pt-8 grid grid-cols-3 gap-6 max-w-md"
              ...
              {[['1985', 'Kuruluş'], ['40+', 'Marka'], ['8.500+', 'Ürün']].map(([n, l]) => (
                <div key={l}>
                  ...
                  <div className="text-[11px] text-slate-500 uppercase tracking-[0.22em] mt-2">{l}</div>
                </div>
              ))}
            </div>
          </div>
