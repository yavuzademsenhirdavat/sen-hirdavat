    ...
    <article className="group bg-white rounded-md border border-slate-200 hover:border-slate-400 transition overflow-hidden flex flex-col">
      ...
      <div className="relative aspect-square bg-slate-50 overflow-hidden">
        ...
        <a
          ...
          className="absolute bottom-2.5 right-2.5 inline-flex items-center gap-1.5 h-8 px-2.5 rounded bg-[#25D366] text-white text-[11px] font-medium hover:bg-[#1ea855] transition shadow-sm"
        >
